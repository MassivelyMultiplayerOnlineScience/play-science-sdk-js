...
import API from './API';
var APIClassifications = /** @class */ (function () {
    function APIClassifications() {
    }
    APIClassifications.create = function (options) {
    ...
    return APIClassifications;
}());
export default APIClassifications;
//# sourceMappingURL=APIClassifications.js.map