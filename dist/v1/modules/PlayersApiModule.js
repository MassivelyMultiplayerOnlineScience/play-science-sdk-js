...
var PlayersApiModule = /** @class */ (function () {
    ...
    */
    PlayersApiModule.prototype.login = function () {
    ...
    */
    PlayersApiModule.prototype.create = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    */
    PlayersApiModule.prototype.linked = function (options) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return PlayersApiModule;
}());
export default PlayersApiModule;
//# sourceMappingURL=PlayersApiModule.js.map