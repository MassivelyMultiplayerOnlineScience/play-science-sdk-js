...
import API from './API';
var APIProjects = /** @class */ (function () {
    function APIProjects() {
    }
    APIProjects.get = function (options) {
    ...
    APIProjects.getTips = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var projectCode, playerCode, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        projectCode = options.projectCode, playerCode = options.playerCode;
                        return [4 /*yield*/, API.call({
                                requestOptions: {
...
//# sourceMappingURL=APIProjects.js.map